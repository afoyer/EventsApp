...
//class DatabaseManager {
    ...
    createEvent( param_list){
        var Poster;
        var Event_ID = param_list[0]
        var Student_ID = param_list[1]
        var Event_Name = param_list[2]
        var Event_Location = param_list[3]
        var Event_Description = param_list[4]
        var Event_Date= param_list[5]
        var Event_Start = param_list[6]
        var Event_End = param_list[7]
        var CCSGA_Approved = param_list[9]
        var Link = param_list[10]
        var Tags = param_list[11]
